...
import { createPiPWindow, TANSTACK_DEVTOOLS, getAllPermutations, DevtoolsContext, MAX_ACTIVE_PLUGINS, uppercaseFirstLetter } from '../chunk/ZUSKEP2N.js';
import { keyboardModifiers } from '../chunk/UGVNF6SI.js';
import { createComponent, Portal, ssr, ssrAttribute, escape, ssrStyle, ssrStyleProperty } from 'solid-js/web';
import { createContext, createSignal, createEffect, onCleanup, Show, createMemo, untrack, For, useContext, onMount } from 'solid-js';
...
var _tmpl$ = "<div></div>";
var _tmpl$2 = ['<button type="button" aria-label="Open TanStack Devtools"', ' style="', '">', "</button>"];
...
var Trigger = (props) => {
  ...
  return createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$2, ssrAttribute("class", escape(buttonStyle(), true), false), ssrStyle(isFloating() && coords() ? {
        left: `${coords().x}px`,
        top: `${coords().y}px`,
        right: "auto",
        bottom: "auto",
...
var _tmpl$4 = ["<div", ' data-testid="tsd-main-panel"', ' style="', '"', ">", "</div>"];
var MainPanel = (props) => {
  const styles = createStyles();
  const {
    height
...
var _tmpl$5 = ["<div", ">", "", "</div>"];
var _tmpl$22 = ['<div data-testid="tsd-resize-handle"', "></div>"];
...
var _tmpl$211 = ['<button type="button" data-testid="', '"', ">", "</button>"];
var _tmpl$38 = ['<div style="', '"><button type="button" data-testid="tsd-pip-button"', ">", '</button><button type="button" data-testid="tsd-close-button"', ">", "</button></div>"];
var Tabs = (props) => {
  const styles = createStyles();
  const {
    state,
  ...
  return ssr(_tmpl$21, ssrAttribute("class", escape(styles().tabContainer, true), false), escape(createComponent(For, {
    each: tabs,
    children: (tab) => ssr(_tmpl$211, `tsd-tab-${escape(tab.id, true)}`, ssrAttribute("class", escape(clsx3(styles().tab, {
