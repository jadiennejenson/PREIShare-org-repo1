...
import { delegateEvents, createComponent, Portal, use, setAttribute, insert, memo, effect, className, style, setStyleProperty, addEventListener, template, classList } from 'solid-js/web';
      ...
      return [createComponent(Section, {
        ...
        get children() {
          return [createComponent(SectionTitle, {
            ...
            insert(_el$5, createComponent(Select, {
              label: "Trigger Mode",
